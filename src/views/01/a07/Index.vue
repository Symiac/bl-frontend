      ...
      <el-button-group>
        ...
        <el-button type="primary">
          <a href="data:text/txt;charset=utf-8,导出下载"
             download="价格类型.xlsx">导出</a></el-button>
      </el-button-group>
    ...
    <template slot="search">
      <el-form inline
        ...
        <div class="search-left">
          <el-form-item>
            <el-input v-model="formSearch.price"
                      style="width:200px"
                      placeholder="价格类型"
                      clearable></el-input>
          </el-form-item>
        ...
        <el-table-column prop="price" 
          ...
          <template slot-scope="scope">
            <span style="color:#004098;cursor:pointer"
                  title="点击修改"
                  @click="edit">{{scope.row.price}}</span>
          </template>
        </el-table-column>
...
interface ISoftwarePriceSearch {
  price: string
  keyword: string
}
@Component({
...
export default class Index extends Vue {
  ...
  selection: any[] = []
  formSearch: ISoftwarePriceSearch = {
    price: '',
    keyword: ''
  }
  tableData: ISoftwarePrice[] = [
    {
      id: 1,
      price: 'A套餐',
      state: '启用',
