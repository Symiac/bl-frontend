  ...
  <layout class="a03">
    ...
    <template slot="search">
      <el-form inline
        ...
        <div class="search-left">
          ...
          <el-form-item>
            <el-input v-model="formSearch.configuration"
                      style="width:100px"
                      placeholder="功能配置"
                      clearable></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="formSearch.version"
                      style="width:100px"
                      placeholder="版本"
                      clearable></el-input>
          </el-form-item>
    ...
    <template slot="content">
      <el-table height="100%"
        ...
        <el-table-column label="软件规格"
                         fixed
                         align="center"
                         width="260">
          <el-table-column prop="configuration"
                           label="功能配置"
                           sortable
                           width="140">
            <template slot-scope="scope">
              <span style="color:#004098;cursor:pointer"
                    title="点击修改"
                    @click="edit">{{scope.row.configuration}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="version"
            ...
            <template slot-scope="scope">
              <span style="color:#004098;cursor:pointer"
                    title="点击修改"
                    @click="edit">{{scope.row.version}}</span>
            </template>
          </el-table-column>
        </el-table-column>
        ...
        <el-table-column prop="createPerson"
                         fixed
                         label="创建人"
                         sortable
                         align="center"
...
interface ISoftwareSpecification {
  category1: string
  category2: string
  variety: string
...
interface ISoftwareSpecificationSearch {
  category1: string
  category2: string
  variety: string
  configuration: string
...
export default class Index extends Vue {
  ...
  selection: any[] = []
  formSearch: ISoftwareSpecificationSearch = {
    category1: '',
    category2: '',
    variety: '',
    configuration: '',
