        ...
        <div class="search-left">
          ...
          <el-form-item>
            <el-select
              ...
              collapse-tags
            >
              <el-option label="已提交" value="01"></el-option>
              <el-option label="启用" value="02"></el-option>
            </el-select>
          </el-form-item>
          <!--
          <el-form-item>
            <el-checkbox checked>已提交</el-checkbox>
        ...
        <el-table-column prop="name"
          ...
          <template slot-scope="scope">
            <span style="color:#004098;cursor:pointer"
                  title="点击修改"
                  @click="edit">{{scope.row.name}}</span>
          </template>
        </el-table-column>
...
interface ISoftwareManufacturer {
  id: string | number
  name: string
  area: string
  state: string
...
interface ISoftwareManufacturerSearch {
  name: string
  keyword: string
}
@Component({
...
export default class Index extends Vue {
  ...
  selection: any[] = []
  formSearch: ISoftwareManufacturerSearch = {
    name: '',
    keyword: ''
  }
  tableData: ISoftwareManufacturer[] = [
    {
      id: 1,
      name: '微软',
      area: '国外',
