      ...
      <el-button-group>
        ...
        <el-button type="primary">
          <a href="data:text/txt;charset=utf-8,导出下载"
             download="费用类别.xlsx">导出</a></el-button>
      </el-button-group>
    ...
    <template slot="search">
      <el-form inline
        ...
        <div class="search-left">
          <el-form-item>
            <el-input v-model="formSearch.expense"
                      style="width:200px"
                      placeholder="费用类别"
                      clearable></el-input>
          </el-form-item>
        ...
        <el-table-column prop="expense" 
          ...
          <template slot-scope="scope">
            <span style="color:#004098;cursor:pointer"
                  title="点击修改"
                  @click="edit">{{scope.row.expense}}</span>
          </template>
        </el-table-column>
...
interface ISoftwareExpenseSearch {
  expense: string
  keyword: string
}
@Component({
...
export default class Index extends Vue {
  ...
  selection: any[] = []
  formSearch: ISoftwareExpenseSearch = {
    expense: '',
    keyword: ''
  }
  tableData: ISoftwareExpense[] = [
    {
      id: 1,
      expense: '新购',
      state: '启用',
