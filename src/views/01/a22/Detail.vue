    ...
    <el-row>
      <el-col :span="12">
        ...
        <el-form-item
          ...
          label-width="120px"
           prop="category1"
          :rules="{
      required: true, message: '未填写类目一名称', trigger: 'blur'
    }"
        >
      ...
      <el-col :span="12">
        <el-form-item
          ...
          prop="category2"
          :rules="{
      required: true, message: '未填写类目二名称', trigger: 'change'
    }"
        >
    ...
    <el-row>
      <el-col :span="24">
        <el-form-item
          ...
          prop="variety"
          :rules="{
      required: true, message: '未填写软件品种名称', trigger: 'blur'
    }"
        >
          <el-autocomplete
            class="inline-input"
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item
          ...
          prop="service"
          :rules="{
      required: true, message: '未填写采购模式', trigger: 'blur'
    }"
        >
          <el-autocomplete
            class="inline-input"
      ...
      <el-col :span="12">
        <el-form-item
          ...
          prop="configuration"
          :rules="{
      required: true, message: '未填写功能配置', trigger: 'blur'
    }"
        >
          <el-autocomplete
            class="inline-input"
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item
          ...
          prop="version"
          :rules="{
      required: true, message: '未填写版本', trigger: 'blur'
    }"
        >
          <el-autocomplete
            class="inline-input"
      ...
      <el-col :span="12">
        <el-form-item
          ...
          prop="manufacturer"
          :rules="{
      required: true, message: '未填写生产厂商', trigger: 'blur'
    }"
        >
          <el-autocomplete
            class="inline-input"
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item
          ...
          prop="area"
          :rules="{
      required: true, message: '未填写软件产地', trigger: 'blur'
    }"
        >
          <el-autocomplete
            class="inline-input"
      ...
      <el-col :span="12">
        <el-form-item
          ...
          prop="adv"
          :rules="{
      required: true, message: '未填写授权方式', trigger: 'blur'
    }"
        >
          <el-autocomplete
            class="inline-input"
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item
          ...
          prop="con"
          :rules="{
      required: true, message: '未填写审批结论', trigger: 'blur'
    }"
        >
          <el-autocomplete
            class="inline-input"
